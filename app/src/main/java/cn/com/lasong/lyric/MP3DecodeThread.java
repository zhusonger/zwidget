        ...
        while (!endOfStream && !isInterrupted()) {
            ...
            try {
                ...
                if (bufferIndex >= 0) {
                    ...
                    if (audioSize < 0) {
                        endOfStream = true;
                        ILog.w("readSampleData : error audioSize = " + audioSize);
            ...
            while (!isInterrupted()) {
                ...
                if (bufferIndex == MediaCodec.INFO_OUTPUT_FORMAT_CHANGED) {
                    ...
                    if (!endOfStream) {
                        ...
                        // wait to end
                        ILog.d("drainEncoder : wait for eos");
                        try {
                            Thread.sleep(10);
                    ...
                    ILog.w("drainEncoder : bufferIndex < 0 ");
                } else {
                    ...
                    if (isReachEnd) {
                        if (!endOfStream) {
                            ...
                            ILog.w("Audio drainEncoder : reached end of stream unexpectedly");
                        } else {
                            ILog.d("Audio drainEncoder : end of stream reached");
                        }
                        break;
                    }
                }
